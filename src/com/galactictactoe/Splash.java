...
public class Splash extends Activity {
	...
	ImageView ciit, subject_code, earthmaniebo, michaelalcaraz, adamguiritan;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		subject_code = (ImageView) findViewById(R.id.subject_code);
		...
		subject_code.startAnimation(fadeIn1);
		Handler sc = new Handler();
